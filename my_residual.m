function [rload ]= my_residual(npoin,nelem,nnode,nstre,ndime,ndofn,ngaus,ntype,lnods,coord,props,posgp, ...
...
for igaus = 1 : ngaus
    ...
    for jgaus = 1 : ngaus2
        ...
        for ievab = 1 : nevab2
            for istre = 1 : nstre
                eload1( :,ievab) = eload1( :,ievab) + ...
                    ((1.0-phigp).^2 + constk) .*bmatx2( :,istre,ievab).* stres( :,kgasp,istre).*dvolum( :,kgasp);
            end
        end
